...
async def process_user_message(message: Message, user_text: str):
    ...
    print(f"User ID: {user_id}, Text: {user_text}")
...
async def handle_text_message(message: Message):
    ...
    if user_text.startswith('/') or user_text in ["📊 Мой статус", "💎 Купить Premium", "💎 Продлить Premium", "🧠 Очистить память", "❓ Помощь", "📈 Статистика", "🎓 Изменить уровень"]:
