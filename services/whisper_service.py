...
def transcribe_audio(audio_file_path):
    ...
    try:
        ...
        # Удаляем неанглийские символы ТОЛЬКО если это НЕ русский и НЕ английский
        # (Например, китайские, арабские символы - возможные ошибки Whisper)
        if text and detected_language not in ["ru", "en", "russian", "english"]:
            original_text = text
